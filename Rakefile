...
def install_homebrew
  ...
  puts '======================================================'
  run %( brew install fzf git httpie hub ifstat openssl python pgcli redis reattach-to-user-namespace ripgrep tmux watch yarn zsh zsh-completions neovim eza zoxide bat the_silver_searcher neofetch cmake)
  puts
  puts
#   puts '======================================================'
