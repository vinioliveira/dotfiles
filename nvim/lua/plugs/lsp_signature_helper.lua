return {
  ...
  toggle_key = '<C-T>', -- toggle signature on and off in insert mode,  e.g. toggle_key = '<M-x>'

  select_signature_key = '<C-n>', -- '<C-n>', -- cycle to next signature, e.g. '<M-n>' function overloading
